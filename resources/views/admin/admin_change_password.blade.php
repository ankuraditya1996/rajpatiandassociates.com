                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.profile') }}">Profile Settings</a>
                                    </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-1">
                                <!-- form -->
                                <form method="post" action="{{ route('update.change.password') }}" class="mt-2 pt-50">
                                @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <div class="input-group form-password-toggle input-group-merge">
                                                <input type="password" class="form-control" id="password_confirmation" name="cpassword_confirmation" placeholder="Confirm your new password" />
