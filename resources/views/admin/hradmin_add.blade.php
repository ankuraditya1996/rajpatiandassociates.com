        ...
        <div class="content-body">
        	<!-- Basic Tables start -->
               <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('hradmin.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="first-name">HR & Administration Name </label>
                                            </div>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="first-name">HR & Administration Designation</label>
                                            </div>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="contact-info">HR & Administration Image</label>
                                            </div>
                                            <div class="col-sm-9">
