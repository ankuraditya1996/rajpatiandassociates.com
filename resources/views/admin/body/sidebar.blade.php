...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="{{ url('/admin/dashboard') }}"><span class="brand-logo">
                    ...
                    <ul class="menu-content">
                       <li class="has-sub" style="">
                        <a class="d-flex align-items-center" href="#">
                            ...
                            <ul class="menu-content">
                                <li class="{{ ( $route == 'admin.onlineinternship')? 'active':'' }}">
                                ...
                                <li class="{{ ( $route == 'admin.offlineinternship')? 'active':'' }}">
                                ...
                                <li class="{{ ( $route == 'admin.specializeinternship')? 'active':'' }}">
                                ...
                                <li class="{{ ( $route == 'admin.trustedinternship')? 'active':'' }}">
                        ...
                        <a class="d-flex align-items-center" href="#">
                            ...
                            <ul class="menu-content">
                               <li class="{{ ( $route == 'vacnacy.view')? 'active':'' }}">
                               ...
                               <li class="{{ ( $route == 'vacnacy.posted')? 'active':'' }}">
                                ...
                                <li class="{{ ( $route == 'job.applicants')? 'active':'' }}">
                                    <a class="d-flex align-items-center" href="{{ route('job.applicants') }}"><span class="menu-item text-truncate" data-i18n="Third Level">View Applicants</span></a>
                                </li>
                             </ul>   
                        </li>
