...
<head>
    ...
    <title>ACTC - Ecommerce Admin Login Page</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">ACTC</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to ACTC ADMIN! 👋</h4>
                                ...
                                <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="ankur@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
