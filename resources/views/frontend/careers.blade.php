            ...
            <div class="row clearfix">
                    ...
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/images/resource/Internship.jpg') }}" alt="">
                                <div class="link"><a href="online-internship.html"><i class="flaticon-link"></i></a></div>
                            ...
                            <div class="lower-content">
                                <div class="box">
                                    ...
                                    <p>Careers</p>
                                    <h4><a href="online-internship.html">Online Internship</a></h4>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/images/resource/Internship.jpg') }}" alt="">
                                <div class="link"><a href="offline-internship.html"><i class="flaticon-link"></i></a></div>
                                <!--<div class="link"><a href="case-details.html"><i class="flaticon-link"></i></a></div>-->
                                <div class="overlay-layer"></div>
                            </figure>
                            <div class="lower-content">
                                <div class="box">
                                    <div class="icon-box"><i class="flaticon-notebook"></i></div>
                                    <p>Careers</p>
                                    <h4><a href="offline-internship.html">Offline Internship</a></h4>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/images/resource/Internship.jpg') }}" alt="">
                                <div class="link"><a href="specialize-internship.html"><i class="flaticon-link"></i></a></div>
                                <!--<div class="link"><a href="case-details.html"><i class="flaticon-link"></i></a></div>-->
                                <div class="overlay-layer"></div>
                            </figure>
                            <div class="lower-content">
                                <div class="box">
                                    <div class="icon-box"><i class="flaticon-notebook"></i></div>
                                    <p>Careers</p>
                                    <h4><a href="specialize-internship.html">Specialize Internship</a></h4>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/images/resource/Internship.jpg') }}" alt="">
                                <div class="link"><a href="trusted-internship.html"><i class="flaticon-link"></i></a></div>
                                <!--<div class="link"><a href="case-details.html"><i class="flaticon-link"></i></a></div>-->
                                <div class="overlay-layer"></div>
                            </figure>
                            <div class="lower-content">
                                <div class="box">
                                    <div class="icon-box"><i class="flaticon-notebook"></i></div>
                                    <p>Careers</p>
                                    <h4><a href="trusted-internship.html">Our Trusted Internship</a></h4>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/images/resource/vacancy2.jpg') }}" alt="">
                                <div class="link"><a href="vacancy.html"><i class="flaticon-link"></i></a></div>
                                <!--<div class="link"><a href="case-details.html"><i class="flaticon-link"></i></a></div>-->
                                <div class="overlay-layer"></div>
                            </figure>
                            <div class="lower-content">
                                <div class="box">
                                    <div class="icon-box"><i class="flaticon-notebook"></i></div>
                                    <p>Careers</p>
                                    <h4><a href="vacancy.html">Vacancy</a></h4>
                                </div>
