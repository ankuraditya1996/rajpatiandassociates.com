...
<!-- Page Title -->
    <section class="page-title style-two" style="background-image:url({{ asset('frontend/images/background/1.jpg') }})">
        <div class="auto-container">
            <h1>Divorce & Matrimonial Matter</h1>
            <ul class="page-breadcrumb">
                <li><a href="index.html">home</a></li>
                <li>Divorce & Matrimonial Matter</li>
            </ul>
        </div>
    </section>
    <!-- End Page Title -->
            ...
            <div class="row clearfix">
                    ...
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/panel/uploads/images/mutualconsentdivorce.jpg') }}" alt="">
                                <div class="link"><a href="#"><i class="flaticon-link"></i></a></div>
                            ...
                            <div class="lower-content">
                                <div class="box">
                                    ...
                                    <p>Law Firm</p>
                                    <h4><a href="#">Mutual Consent Divorce</a></h4>
                                </div>
                                <div class="link"><a href="description.html?name=dmm&id=2"><i class="flaticon-right"></i>Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/panel/uploads/images/anulmentofimage.jpg') }}" alt="">
                                <div class="link"><a href="#"><i class="flaticon-link"></i></a></div>
                                <!--<div class="link"><a href="case-details.html"><i class="flaticon-link"></i></a></div>-->
                                <div class="overlay-layer"></div>
                            </figure>
                            <div class="lower-content">
                                <div class="box">
                                    <div class="icon-box"><i class="flaticon-notebook"></i></div>
                                    <p>Law Firm</p>
                                    <h4><a href="#">Annulment of Marriage</a></h4>
                                </div>
                                <div class="link"><a href="description-1.html?name=dmm&id=3"><i class="flaticon-right"></i>Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                    <div class="case-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{ asset('frontend/panel/uploads/images/contesteddivorce.jpg') }}" alt="">
                                <div class="link"><a href="#"><i class="flaticon-link"></i></a></div>
                                <!--<div class="link"><a href="case-details.html"><i class="flaticon-link"></i></a></div>-->
                                <div class="overlay-layer"></div>
                            </figure>
                            <div class="lower-content">
                                <div class="box">
                                    <div class="icon-box"><i class="flaticon-notebook"></i></div>
                                    <p>Law Firm</p>
                                    <h4><a href="#">Contested Divorce</a></h4>
                                </div>
                                <div class="link"><a href="description-2.html?name=dmm&id=4"><i class="flaticon-right"></i>Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
